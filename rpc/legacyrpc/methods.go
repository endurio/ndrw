...
// request into a marshalable response.  If the error is a *chainjson.RPCError
...
// catch-all error code, chainjson.ErrRPCWallet.
...
// context.
type lazyHandler func() (interface{}, *chainjson.RPCError)
...
func lazyApplyHandler(request *chainjson.Request, w *wallet.Wallet, chainClient chain.Interface) lazyHandler {
	handlerData, ok := rpcHandlers[request.Method]
	if ok && handlerData.handlerWithChain != nil && w != nil && chainClient != nil {
		return func() (interface{}, *chainjson.RPCError) {
			cmd, err := chainjson.UnmarshalCmd(request)
			if err != nil {
				return nil, chainjson.ErrRPCInvalidRequest
			}
...
func makeResponse(id, result interface{}, err error) chainjson.Response {
	idPtr := idPointer(id)
	if err != nil {
		return chainjson.Response{
			ID:    idPtr,
			Error: jsonError(err),
		}
	}
...
func jsonError(err error) *chainjson.RPCError {
	if err == nil {
		return nil
	}
	...
	case waddrmgr.ManagerError:
		...
		case waddrmgr.ErrWrongPassphrase:
			code = chainjson.ErrRPCWalletPassphraseIncorrect
		}
	}
...
func makeMultiSigScript(w *wallet.Wallet, keys []string, nRequired int) ([]byte, error) {
	keysesPrecious := make([]*chainutil.AddressPubKey, len(keys))
...
func addMultiSigAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.AddMultisigAddressCmd)
	...
	secp256k1Addrs := make([]chainutil.Address, len(cmd.Keys))
...
func createMultiSig(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.CreateMultisigCmd)
	...
	address, err := chainutil.NewAddressScriptHash(script, w.ChainParams())
	if err != nil {
		// above is a valid script, shouldn't happen.
		return nil, err
	}

	return chainjson.CreateMultiSigResult{
...
func dumpPrivKey(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.DumpPrivKeyCmd)
...
func getAddressesByAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.GetAddressesByAccountCmd)
...
func getBalance(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.GetBalanceCmd)
...
// information about the current state of ndrw.
// exist.
func getInfo(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	// Call down to ndrd for all of the information in this command known
	// by them.
...
func decodeAddress(s string, params *chaincfg.Params) (chainutil.Address, error) {
	addr, err := chainutil.DecodeAddress(s, params)
	if err != nil {
...
func getAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.GetAccountCmd)
...
// runs out (and will return chainjson.ErrRPCWalletKeypoolRanOut if that happens).
func getAccountAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.GetAccountAddressCmd)
...
func getUnconfirmedBalance(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.GetUnconfirmedBalanceCmd)
...
func importPrivKey(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.ImportPrivKeyCmd)
	...
	wif, err := chainutil.DecodeWIF(cmd.PrivKey)
	if err != nil {
		return nil, &chainjson.RPCError{
			Code:    chainjson.ErrRPCInvalidAddressOrKey,
...
func createNewAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.CreateNewAccountCmd)
...
func renameAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.RenameAccountCmd)
...
func getNewAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.GetNewAddressCmd)
...
func getRawChangeAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.GetRawChangeAddressCmd)
...
func getReceivedByAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.GetReceivedByAccountCmd)
...
func getReceivedByAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.GetReceivedByAddressCmd)
...
func getTransaction(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.GetTransactionCmd)

	txHash, err := chainhash.NewHashFromStr(cmd.Txid)
	if err != nil {
		return nil, &chainjson.RPCError{
			Code:    chainjson.ErrRPCDecodeHexString,
	...
	ret := chainjson.GetTransactionResult{
		TxID:            cmd.Txid,
	...
	var (
		debitTotal  chainutil.Amount
		creditTotal chainutil.Amount // Excludes change
	...
	if len(details.Debits) == len(details.MsgTx.TxIn) {
		var outputTotal chainutil.Amount
		for _, output := range details.MsgTx.TxOut {
			outputTotal += chainutil.Amount(output.Value)
		}
	...
	if len(details.Debits) == 0 {
		...
		ret.Details = make([]chainjson.GetTransactionDetailsResult, 0, len(details.Credits))
	} else {
		ret.Details = make([]chainjson.GetTransactionDetailsResult, 1, len(details.Credits)+1)

		ret.Details[0] = chainjson.GetTransactionDetailsResult{
			// Fields left zeroed:
			//   InvolvesWatchOnly
			//   Account
			//   Address
	...
	for _, cred := range details.Credits {
		...
		ret.Details = append(ret.Details, chainjson.GetTransactionDetailsResult{
			// Fields left zeroed:
			//   InvolvesWatchOnly
			//   Fee
			Account:  accountName,
...
func help(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*chainjson.HelpCmd)

	// ndrd returns different help messages depending on the kind of
	...
	// wallet itself is a websocket client to ndrd.  Therefore, create a
	...
	// texts in a non-internal ndrd package.
...
func listAccounts(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.ListAccountsCmd)
...
func listReceivedByAccount(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.ListReceivedByAccountCmd)
	...
	jsonResults := make([]chainjson.ListReceivedByAccountResult, 0, len(results))
	for _, result := range results {
		jsonResults = append(jsonResults, chainjson.ListReceivedByAccountResult{
...
func listReceivedByAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.ListReceivedByAddressCmd)
	...
	ret := make([]chainjson.ListReceivedByAddressResult, numAddresses, numAddresses)
	idx := 0
	for address, addrData := range allAddrData {
		ret[idx] = chainjson.ListReceivedByAddressResult{
			Address:       address,
...
func listSinceBlock(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*chainjson.ListSinceBlockCmd)
	...
	res := chainjson.ListSinceBlockResult{
...
func listTransactions(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.ListTransactionsCmd)
...
func listAddressTransactions(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.ListAddressTransactionsCmd)
...
func listAllTransactions(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.ListAllTransactionsCmd)
...
func listUnspent(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.ListUnspentCmd)
...
func lockUnspent(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.LockUnspentCmd)
...
func sendFrom(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*chainjson.SendFromCmd)
	...
	amt, err := chainutil.NewAmount(cmd.Amount)
	if err != nil {
		return nil, err
	}
...
func sendMany(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.SendManyCmd)
	...
	pairs := make(map[string]chainutil.Amount, len(cmd.Amounts))
	for k, v := range cmd.Amounts {
		amt, err := chainutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
		pairs[k] = amt
...
func sendToAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.SendToAddressCmd)
...
func setTxFee(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.SetTxFeeCmd)
...
func signMessage(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.SignMessageCmd)
	...
	sigbytes, err := chainec.SignCompact(chainec.S256(), privKey,
		messageHash, true)
	if err != nil {
		return nil, err
	}
...
func signRawTransaction(icmd interface{}, w *wallet.Wallet, chainClient *chain.RPCClient) (interface{}, error) {
	cmd := icmd.(*chainjson.SignRawTransactionCmd)
	...
	var cmdInputs []chainjson.RawTxInput
	if cmd.Inputs != nil {
	...
	for _, rti := range cmdInputs {
		...
		if cmd.PrivKeys != nil && len(*cmd.PrivKeys) != 0 {
			...
			addr, err := chainutil.NewAddressScriptHash(redeemScript,
				w.ChainParams())
			if err != nil {
				return nil, DeserializationError{err}
			}
	...
	var keys map[string]*chainutil.WIF
	if cmd.PrivKeys != nil {
		keys = make(map[string]*chainutil.WIF)

		for _, key := range *cmd.PrivKeys {
			wif, err := chainutil.DecodeWIF(key)
			if err != nil {
				return nil, DeserializationError{err}
			}
			...
			addr, err := chainutil.NewAddressPubKey(wif.SerializePubKey(),
				w.ChainParams())
			if err != nil {
				return nil, DeserializationError{err}
			}
	...
	signErrors := make([]chainjson.SignRawTransactionError, 0, len(signErrs))
	for _, e := range signErrs {
		input := tx.TxIn[e.InputIndex]
		signErrors = append(signErrors, chainjson.SignRawTransactionError{
	...
	return chainjson.SignRawTransactionResult{
...
func validateAddress(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.ValidateAddressCmd)

	result := chainjson.ValidateAddressWalletResult{}
	addr, err := decodeAddress(cmd.Address, w.ChainParams())
	if err != nil {
...
func verifyMessage(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.VerifyMessageCmd)
	...
	case *chainutil.AddressPubKeyHash: // ok
		return bytes.Equal(chainutil.Hash160(serializedPubKey), checkAddr.Hash160()[:]), nil
	case *chainutil.AddressPubKey: // ok
...
func walletPassphrase(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.WalletPassphraseCmd)
...
func walletPassphraseChange(icmd interface{}, w *wallet.Wallet) (interface{}, error) {
	cmd := icmd.(*chainjson.WalletPassphraseChangeCmd)
