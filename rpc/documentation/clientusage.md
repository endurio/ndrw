...
var certificateFile = filepath.Join(chainutil.AppDataDir("ndrw", false), "rpc.cert")
...
func main() {
	...
	fmt.Println("Spendable balance: ", chainutil.Amount(balanceResponse.Spendable))
}
```
...
var certPath = path.join(process.env.HOME, '.ndrw', 'rpc.cert');
