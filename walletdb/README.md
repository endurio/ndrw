...
[![GoDoc](https://godoc.org/github.com/endurio/ndrw/walletdb?status.png)]
(http://godoc.org/github.com/endurio/ndrw/walletdb)
...
http://localhost:6060/pkg/github.com/endurio/ndrw/walletdb

## Installation

```bash
$ go get github.com/endurio/ndrw/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/endurio/ndrw/walletdb#example-package--BasicUsage)  
