...
func NewBlockFilterer(params *chaincfg.Params,
	...
	foundOutPoints := make(map[wire.OutPoint]chainutil.Address)
...
// interest.
func (bf *BlockFilterer) FilterOutputAddrs(addrs []chainutil.Address) bool {
	var isRelevant bool
